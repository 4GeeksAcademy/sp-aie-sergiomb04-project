...
import { binarySearchProductByWeight, findProductBySKU, findShipmentById } from "./utils/search.js";
...
console.log("Búsqueda binaria por peso:", binarySearchProductByWeight([...sampleProducts].sort((a, b) => a.weightKg - b.weightKg), 2.3));
if (laptop) {
