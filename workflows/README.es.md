...
- **Recomendación**: documenta cada workflow que añadas (disparadores, entradas/salidas, credenciales requeridas, pasos, manejo de errores) y enlázalo con las uis/pipelines/agentes involucrados.
